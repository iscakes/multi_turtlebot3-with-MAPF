...
(cl:defclass <FollowingState> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass FollowingState (<FollowingState>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <FollowingState>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'FollowingState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robint_msgs-msg:<FollowingState> is deprecated: use robint_msgs-msg:FollowingState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <FollowingState>))
...
(cl:defmethod status-val ((m <FollowingState>))
...
(cl:defmethod r_state-val ((m <FollowingState>))
...
(cl:defmethod r_feedback-val ((m <FollowingState>))
...
(cl:defmethod finished-val ((m <FollowingState>))
  ...
  (finished m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <FollowingState>) ostream)
  "Serializes a message object of type '<FollowingState>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FollowingState>) istream)
  "Deserializes a message object of type '<FollowingState>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FollowingState>)))
  "Returns string type for a message object of type '<FollowingState>"
  "robint_msgs/FollowingState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FollowingState)))
  "Returns string type for a message object of type 'FollowingState"
  "robint_msgs/FollowingState")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FollowingState>)))
  "Returns md5sum for a message object of type '<FollowingState>"
  "f9cd510711a279aa8692bd352c32f8ce")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FollowingState)))
  "Returns md5sum for a message object of type 'FollowingState"
  "f9cd510711a279aa8692bd352c32f8ce")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FollowingState>)))
  "Returns full string definition for message of type '<FollowingState>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FollowingState)))
  "Returns full string definition for message of type 'FollowingState"
  (cl:format cl:nil "TaskStateHeader header~%uint8 status~%uint8 r_state~%uint8 r_feedback~%bool finished~%================================================================================~%MSG: robint_msgs/TaskStateHeader~%bool activate  # 该任务是否处于激活状态~%time start_time~%time stop_time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <FollowingState>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <FollowingState>))
  "Converts a ROS message object to a list"
  (cl:list 'FollowingState
