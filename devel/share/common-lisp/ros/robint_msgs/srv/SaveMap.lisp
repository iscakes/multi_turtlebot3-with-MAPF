...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robint_msgs-srv:<SaveMap-request> is deprecated: use robint_msgs-srv:SaveMap-request instead.")))
...
(cl:defmethod floor_id-val ((m <SaveMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robint_msgs-srv:floor_id-val is deprecated.  Use robint_msgs-srv:floor_id instead.")
  (floor_id m))

(cl:ensure-generic-function 'building_id-val :lambda-list '(m))
(cl:defmethod building_id-val ((m <SaveMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robint_msgs-srv:building_id-val is deprecated.  Use robint_msgs-srv:building_id instead.")
  (building_id m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <SaveMap-request>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SaveMap-request>)))
  ...
  "4f7dafe19f911c0cae117f85fceab982")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SaveMap-request)))
  "Returns md5sum for a message object of type 'SaveMap-request"
  "4f7dafe19f911c0cae117f85fceab982")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SaveMap-request>)))
  ...
  (cl:format cl:nil "string map_name~%string floor_id~%string building_id~%string time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SaveMap-request)))
  "Returns full string definition for message of type 'SaveMap-request"
  (cl:format cl:nil "string map_name~%string floor_id~%string building_id~%string time~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robint_msgs-srv:<SaveMap-response> is deprecated: use robint_msgs-srv:SaveMap-response instead.")))

(cl:ensure-generic-function 'map_uuid-val :lambda-list '(m))
(cl:defmethod map_uuid-val ((m <SaveMap-response>))
...
(cl:defmethod error_code-val ((m <SaveMap-response>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SaveMap-response>)))
  ...
  (cl:format cl:nil "string map_uuid~%bool success~%uint8 error_code~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SaveMap-response)))
  "Returns full string definition for message of type 'SaveMap-response"
  (cl:format cl:nil "string map_uuid~%bool success~%uint8 error_code~%~%~%"))
