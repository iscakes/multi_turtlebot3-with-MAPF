...
class CopyLocationListRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CopyLocationListRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CopyLocationListRequest
    let len;
    let data = new CopyLocationListRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CopyLocationListRequest(null);
...
class CopyLocationListResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CopyLocationListResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CopyLocationListResponse
    let len;
    let data = new CopyLocationListResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CopyLocationListResponse(null);
...
module.exports = {
  Request: CopyLocationListRequest,
  Response: CopyLocationListResponse,
  md5sum() { return '0302d3157602f7391af07cad52331553'; },
  datatype() { return 'robint_msgs/CopyLocationList'; }
};
