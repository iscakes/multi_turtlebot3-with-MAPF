...
class CopyZoneListRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CopyZoneListRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CopyZoneListRequest
    let len;
    let data = new CopyZoneListRequest(null);
  ...
  static datatype() {
    ...
    return 'robint_msgs/CopyZoneListRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CopyZoneListRequest(null);
...
class CopyZoneListResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CopyZoneListResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CopyZoneListResponse
    let len;
    let data = new CopyZoneListResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CopyZoneListResponse(null);
...
module.exports = {
  Request: CopyZoneListRequest,
  Response: CopyZoneListResponse,
  md5sum() { return '8b11985cf92920b4eb79531e78124b68'; },
  datatype() { return 'robint_msgs/CopyZoneList'; }
};
