...
class GetVirtualWallListRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetVirtualWallListRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetVirtualWallListRequest
    let len;
    let data = new GetVirtualWallListRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetVirtualWallListRequest(null);
...
GetVirtualWallListRequest.Constants = {
  IMAGE: 0,
  WORLD: 1,
}

class GetVirtualWallListResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.wall_list = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetVirtualWallListResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetVirtualWallListResponse
    let len;
    let data = new GetVirtualWallListResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetVirtualWallListResponse(null);
...
module.exports = {
  Request: GetVirtualWallListRequest,
  Response: GetVirtualWallListResponse,
  md5sum() { return '97620b03c4f2a28bcc6888c4a51a4cc2'; },
  datatype() { return 'robint_msgs/GetVirtualWallList'; }
};
