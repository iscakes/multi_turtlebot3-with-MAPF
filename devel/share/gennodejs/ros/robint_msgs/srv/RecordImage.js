...
class RecordImageRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RecordImageRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RecordImageRequest
    let len;
    let data = new RecordImageRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RecordImageRequest(null);
...
class RecordImageResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RecordImageResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RecordImageResponse
    let len;
    let data = new RecordImageResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robint_msgs/RecordImageResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RecordImageResponse(null);
...
module.exports = {
  Request: RecordImageRequest,
  Response: RecordImageResponse,
  md5sum() { return '773a71c89a6b14108e80ced63f2ba488'; },
  datatype() { return 'robint_msgs/RecordImage'; }
};
