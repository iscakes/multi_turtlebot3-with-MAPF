...
class UpdateNavGoalRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type UpdateNavGoalRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type UpdateNavGoalRequest
    let len;
    let data = new UpdateNavGoalRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new UpdateNavGoalRequest(null);
...
class UpdateNavGoalResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type UpdateNavGoalResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type UpdateNavGoalResponse
    let len;
    let data = new UpdateNavGoalResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robint_msgs/UpdateNavGoalResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UpdateNavGoalResponse(null);
...
module.exports = {
  Request: UpdateNavGoalRequest,
  Response: UpdateNavGoalResponse,
  md5sum() { return '548e99f135dd6026231a1f7b41de0e99'; },
  datatype() { return 'robint_msgs/UpdateNavGoal'; }
};
