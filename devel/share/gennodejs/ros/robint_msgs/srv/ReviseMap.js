...
class ReviseMapRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ReviseMapRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ReviseMapRequest
    let len;
    let data = new ReviseMapRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReviseMapRequest(null);
...
class ReviseMapResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ReviseMapResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ReviseMapResponse
    let len;
    let data = new ReviseMapResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robint_msgs/ReviseMapResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReviseMapResponse(null);
...
module.exports = {
  Request: ReviseMapRequest,
  Response: ReviseMapResponse,
  md5sum() { return '61d4f94e645500014ea40345198ee9cb'; },
  datatype() { return 'robint_msgs/ReviseMap'; }
};
