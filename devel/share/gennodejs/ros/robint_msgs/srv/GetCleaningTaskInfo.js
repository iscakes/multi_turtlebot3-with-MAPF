...
class GetCleaningTaskInfoRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCleaningTaskInfoRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCleaningTaskInfoRequest
    let len;
    let data = new GetCleaningTaskInfoRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCleaningTaskInfoRequest(null);
...
GetCleaningTaskInfoRequest.Constants = {
  IMAGE: 0,
  WORLD: 1,
}

class GetCleaningTaskInfoResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.area = null;
      this.robot_is_inside_area = null;
      this.success = null;
      ...
      if (initObj.hasOwnProperty('robot_is_inside_area')) {
        this.robot_is_inside_area = initObj.robot_is_inside_area
      }
      else {
        this.robot_is_inside_area = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCleaningTaskInfoResponse
    // Serialize message field [area]
    bufferOffset = CleaningArea.serialize(obj.area, buffer, bufferOffset);
    // Serialize message field [robot_is_inside_area]
    bufferOffset = _serializer.bool(obj.robot_is_inside_area, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCleaningTaskInfoResponse
    let len;
    let data = new GetCleaningTaskInfoResponse(null);
    // Deserialize message field [area]
    data.area = CleaningArea.deserialize(buffer, bufferOffset);
    // Deserialize message field [robot_is_inside_area]
    data.robot_is_inside_area = _deserializer.bool(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCleaningTaskInfoResponse(null);
    ...
    if (msg.robot_is_inside_area !== undefined) {
      resolved.robot_is_inside_area = msg.robot_is_inside_area;
    }
    else {
      resolved.robot_is_inside_area = false
    }
...
module.exports = {
  Request: GetCleaningTaskInfoRequest,
  Response: GetCleaningTaskInfoResponse,
  md5sum() { return '2c13b4f1da851ed54f7a178d55630472'; },
  datatype() { return 'robint_msgs/GetCleaningTaskInfo'; }
};
