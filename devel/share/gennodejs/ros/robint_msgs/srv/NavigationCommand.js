...
class NavigationCommandRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NavigationCommandRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NavigationCommandRequest
    let len;
    let data = new NavigationCommandRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavigationCommandRequest(null);
...
NavigationCommandRequest.Constants = {
  START: 0,
  PAUSE: 1,
  CONTINUE: 2,
  STOP: 3,
...
class NavigationCommandResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NavigationCommandResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NavigationCommandResponse
    let len;
    let data = new NavigationCommandResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robint_msgs/NavigationCommandResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavigationCommandResponse(null);
...
module.exports = {
  ...
  datatype() { return 'robint_msgs/NavigationCommand'; }
};
