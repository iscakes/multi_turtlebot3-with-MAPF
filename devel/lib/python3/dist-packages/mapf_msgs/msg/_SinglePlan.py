...
"""autogenerated by genpy from mapf_msgs/SinglePlan.msg. Do not edit."""
import codecs
import sys
...
class SinglePlan(genpy.Message):
  _md5sum = "bee8d3f33f362001a6964a4d3ecc61ee"
  _type = "mapf_msgs/SinglePlan"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32[] time_step
nav_msgs/Path plan
================================================================================
MSG: nav_msgs/Path
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.time_step))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.time_step = s.unpack(str[start:end])
      _x = self
      start = end
      end += 12
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.time_step = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      _x = self
      start = end
      end += 12
      (_x.plan.header.seq, _x.plan.header.stamp.secs, _x.plan.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
