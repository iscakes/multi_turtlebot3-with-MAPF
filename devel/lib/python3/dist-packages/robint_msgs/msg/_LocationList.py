...
"""autogenerated by genpy from robint_msgs/LocationList.msg. Do not edit."""
import codecs
import sys
...
class LocationList(genpy.Message):
  _md5sum = "45c706effb773a01496477e85f31d662"
  _type = "robint_msgs/LocationList"
...
float64 w
"""
  __slots__ = ['map_name','map_uuid','location_list']
  _slot_types = ['string','string','robint_msgs/Location[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       map_name,map_uuid,location_list
