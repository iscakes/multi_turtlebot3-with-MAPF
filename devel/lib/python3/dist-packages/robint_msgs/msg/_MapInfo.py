...
"""autogenerated by genpy from robint_msgs/MapInfo.msg. Do not edit."""
import codecs
import sys
...
class MapInfo(genpy.Message):
  _md5sum = "25eff9fc3c56759ad869d6ff263f07dc"
  _type = "robint_msgs/MapInfo"
...
uint32 width
uint32 height"""
  __slots__ = ['uuid','name','floor_id','building_id','time','origin','width','height']
  _slot_types = ['string','string','string','string','string','float32[]','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       uuid,name,floor_id,building_id,time,origin,width,height
