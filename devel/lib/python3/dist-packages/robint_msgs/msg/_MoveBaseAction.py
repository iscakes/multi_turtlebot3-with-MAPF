...
"""autogenerated by genpy from robint_msgs/MoveBaseAction.msg. Do not edit."""
import codecs
import sys
...
class MoveBaseAction(genpy.Message):
  _md5sum = "b8da4bcc9ba780e6f0c3a362f0ecfa3d"
  _type = "robint_msgs/MoveBaseAction"
...
"""
  ...
  _slot_types = ['robint_msgs/MoveBaseActionGoal','robint_msgs/MoveBaseActionResult','robint_msgs/MoveBaseActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = robint_msgs.msg.MoveBaseActionGoal()
      if self.action_result is None:
        self.action_result = robint_msgs.msg.MoveBaseActionResult()
      if self.action_feedback is None:
        self.action_feedback = robint_msgs.msg.MoveBaseActionFeedback()
    else:
      self.action_goal = robint_msgs.msg.MoveBaseActionGoal()
      self.action_result = robint_msgs.msg.MoveBaseActionResult()
      self.action_feedback = robint_msgs.msg.MoveBaseActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3B3I().pack(_x.action_goal.goal.enable_goal_candidate_search, _x.action_goal.goal.enable_goal_increase_tolerance, _x.action_goal.goal.enable_fixed_straight_path, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.goal_type = str[start:end]
      _x = self
      start = end
      end += 15
      (_x.action_goal.goal.enable_goal_candidate_search, _x.action_goal.goal.enable_goal_increase_tolerance, _x.action_goal.goal.enable_fixed_straight_path, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_3B3I().unpack(str[start:end])
      self.action_goal.goal.enable_goal_candidate_search = bool(self.action_goal.goal.enable_goal_candidate_search)
      self.action_goal.goal.enable_goal_increase_tolerance = bool(self.action_goal.goal.enable_goal_increase_tolerance)
      self.action_goal.goal.enable_fixed_straight_path = bool(self.action_goal.goal.enable_fixed_straight_path)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
