...
"""autogenerated by genpy from robint_msgs/ImageInfo.msg. Do not edit."""
import codecs
import sys
...
class ImageInfo(genpy.Message):
  _md5sum = "ec708a88adeb2d16cf2e489c284cf4e3"
  _type = "robint_msgs/ImageInfo"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string id
string base64
string format"""
  __slots__ = ['id','base64','format']
