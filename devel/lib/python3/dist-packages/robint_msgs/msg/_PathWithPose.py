...
"""autogenerated by genpy from robint_msgs/PathWithPose.msg. Do not edit."""
import codecs
import sys
...
class PathWithPose(genpy.Message):
  _md5sum = "ec221984b1c5baa24faad852642bf206"
  _type = "robint_msgs/PathWithPose"
...
float64 w
"""
  __slots__ = ['id','type','poses']
  _slot_types = ['uint32','string','geometry_msgs/PoseStamped[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PathWithPose, self).__init__(*args, **kwds)
