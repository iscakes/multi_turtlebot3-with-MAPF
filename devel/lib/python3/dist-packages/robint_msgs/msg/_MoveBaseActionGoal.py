...
"""autogenerated by genpy from robint_msgs/MoveBaseActionGoal.msg. Do not edit."""
import codecs
import sys
...
class MoveBaseActionGoal(genpy.Message):
  _md5sum = "2b45467e927f38ba0080207906a9236f"
  _type = "robint_msgs/MoveBaseActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','robint_msgs/MoveBaseGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = robint_msgs.msg.MoveBaseGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = robint_msgs.msg.MoveBaseGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3B().pack(_x.goal.enable_goal_candidate_search, _x.goal.enable_goal_increase_tolerance, _x.goal.enable_fixed_straight_path))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.goal_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.goal_type = str[start:end]
      _x = self
      start = end
      end += 3
      (_x.goal.enable_goal_candidate_search, _x.goal.enable_goal_increase_tolerance, _x.goal.enable_fixed_straight_path,) = _get_struct_3B().unpack(str[start:end])
      self.goal.enable_goal_candidate_search = bool(self.goal.enable_goal_candidate_search)
      self.goal.enable_goal_increase_tolerance = bool(self.goal.enable_goal_increase_tolerance)
      self.goal.enable_fixed_straight_path = bool(self.goal.enable_fixed_straight_path)
      return self
