...
"""autogenerated by genpy from robint_msgs/IsolatedWait.msg. Do not edit."""
import codecs
import sys
...
class IsolatedWait(genpy.Message):
  _md5sum = "daf9e3b0429e595e00ee93cf39383683"
  _type = "robint_msgs/IsolatedWait"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IsolatedWait, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.direct,) = _get_struct_B().unpack(str[start:end])
      self.direct = bool(self.direct)
      return self
