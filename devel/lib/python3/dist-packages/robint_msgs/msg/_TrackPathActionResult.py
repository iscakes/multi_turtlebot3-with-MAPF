...
"""autogenerated by genpy from robint_msgs/TrackPathActionResult.msg. Do not edit."""
import codecs
import sys
...
class TrackPathActionResult(genpy.Message):
  ...
  _type = "robint_msgs/TrackPathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robint_msgs/TrackPathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = robint_msgs.msg.TrackPathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robint_msgs.msg.TrackPathResult()
