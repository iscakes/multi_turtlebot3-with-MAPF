...
"""autogenerated by genpy from robint_msgs/NavigationTaskInfo.msg. Do not edit."""
import codecs
import sys
...
class NavigationTaskInfo(genpy.Message):
  _md5sum = "f44628125c7d26f45ef57fabf8e88cc4"
  _type = "robint_msgs/NavigationTaskInfo"
...
string uuid
bool direct"""
  __slots__ = ['current_map_uuid','elevator_building_uuid','current_floor_id','target_map_uuid','target_floor_id','target_loc_uuid','target_loc_group_uuid','enter_elevator_loc_uuid','current_elevator_interior_loc_uuid','target_elevator_interior_loc_uuid','elevator_wait_loc_uuid','current_exit_elevator_loc_uuid','target_exit_elevator_loc_uuid','dock_anchor_pose','current_floor_gates','target_floor_gates','current_floor_isolated_zones','target_floor_isolated_zones']
  _slot_types = ['string','string','string','string','string','string','string','string','string','string','string','string','string','geometry_msgs/PoseStamped','robint_msgs/GateInfo[]','robint_msgs/GateInfo[]','robint_msgs/IsolatedZone[]','robint_msgs/IsolatedZone[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       current_map_uuid,elevator_building_uuid,current_floor_id,target_map_uuid,target_floor_id,target_loc_uuid,target_loc_group_uuid,enter_elevator_loc_uuid,current_elevator_interior_loc_uuid,target_elevator_interior_loc_uuid,elevator_wait_loc_uuid,current_exit_elevator_loc_uuid,target_exit_elevator_loc_uuid,dock_anchor_pose,current_floor_gates,target_floor_gates,current_floor_isolated_zones,target_floor_isolated_zones
    ...
    """
    if args or kwds:
      super(NavigationTaskInfo, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.current_map_uuid is None:
        self.current_map_uuid = ''
      if self.elevator_building_uuid is None:
        self.elevator_building_uuid = ''
      ...
      if self.target_loc_group_uuid is None:
        self.target_loc_group_uuid = ''
      if self.enter_elevator_loc_uuid is None:
        self.enter_elevator_loc_uuid = ''
      if self.current_elevator_interior_loc_uuid is None:
        self.current_elevator_interior_loc_uuid = ''
      if self.target_elevator_interior_loc_uuid is None:
        self.target_elevator_interior_loc_uuid = ''
      if self.elevator_wait_loc_uuid is None:
        self.elevator_wait_loc_uuid = ''
      if self.current_exit_elevator_loc_uuid is None:
        self.current_exit_elevator_loc_uuid = ''
      if self.target_exit_elevator_loc_uuid is None:
        self.target_exit_elevator_loc_uuid = ''
      if self.dock_anchor_pose is None:
        self.dock_anchor_pose = geometry_msgs.msg.PoseStamped()
      if self.current_floor_gates is None:
        self.current_floor_gates = []
      if self.target_floor_gates is None:
        self.target_floor_gates = []
      if self.current_floor_isolated_zones is None:
        self.current_floor_isolated_zones = []
      if self.target_floor_isolated_zones is None:
        self.target_floor_isolated_zones = []
    else:
      self.current_map_uuid = ''
      self.elevator_building_uuid = ''
      self.current_floor_id = ''
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.elevator_building_uuid
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.current_elevator_interior_loc_uuid
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.target_elevator_interior_loc_uuid
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.current_exit_elevator_loc_uuid
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.target_exit_elevator_loc_uuid
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.dock_anchor_pose.header.seq, _x.dock_anchor_pose.header.stamp.secs, _x.dock_anchor_pose.header.stamp.nsecs))
      _x = self.dock_anchor_pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7d().pack(_x.dock_anchor_pose.pose.position.x, _x.dock_anchor_pose.pose.position.y, _x.dock_anchor_pose.pose.position.z, _x.dock_anchor_pose.pose.orientation.x, _x.dock_anchor_pose.pose.orientation.y, _x.dock_anchor_pose.pose.orientation.z, _x.dock_anchor_pose.pose.orientation.w))
      length = len(self.current_floor_gates)
      buff.write(_struct_I.pack(length))
      for val1 in self.current_floor_gates:
        _x = val1.gate_uuid
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = _v18
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.target_floor_gates)
      buff.write(_struct_I.pack(length))
      for val1 in self.target_floor_gates:
        _x = val1.gate_uuid
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _x = _v36
        buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
      length = len(self.current_floor_isolated_zones)
      buff.write(_struct_I.pack(length))
      for val1 in self.current_floor_isolated_zones:
        _v37 = val1.zone
        _x = _v37.uuid
        length = len(_x)
        if python3 or type(_x) == unicode:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.target_floor_isolated_zones)
      buff.write(_struct_I.pack(length))
      for val1 in self.target_floor_isolated_zones:
        _v41 = val1.zone
        _x = _v41.uuid
        length = len(_x)
        if python3 or type(_x) == unicode:
  ...
  def deserialize(self, str):
    ...
    try:
      if self.dock_anchor_pose is None:
        self.dock_anchor_pose = geometry_msgs.msg.PoseStamped()
      if self.current_floor_gates is None:
        self.current_floor_gates = None
      if self.target_floor_gates is None:
        self.target_floor_gates = None
      if self.current_floor_isolated_zones is None:
        self.current_floor_isolated_zones = None
      if self.target_floor_isolated_zones is None:
        self.target_floor_isolated_zones = None
      end = 0
      start = end
      end += 4
      ...
      if python3:
        self.elevator_building_uuid = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.elevator_building_uuid = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.target_loc_group_uuid = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.target_loc_group_uuid = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.current_elevator_interior_loc_uuid = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.current_elevator_interior_loc_uuid = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.target_elevator_interior_loc_uuid = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.target_elevator_interior_loc_uuid = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.current_exit_elevator_loc_uuid = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.current_exit_elevator_loc_uuid = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.target_exit_elevator_loc_uuid = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.target_exit_elevator_loc_uuid = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.dock_anchor_pose.header.seq, _x.dock_anchor_pose.header.stamp.secs, _x.dock_anchor_pose.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.dock_anchor_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.dock_anchor_pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 56
      (_x.dock_anchor_pose.pose.position.x, _x.dock_anchor_pose.pose.position.y, _x.dock_anchor_pose.pose.position.z, _x.dock_anchor_pose.pose.orientation.x, _x.dock_anchor_pose.pose.orientation.y, _x.dock_anchor_pose.pose.orientation.z, _x.dock_anchor_pose.pose.orientation.w,) = _get_struct_7d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.current_floor_gates = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
        self.current_floor_gates.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.target_floor_gates = []
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
        self.target_floor_gates.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.current_floor_isolated_zones = []
      for i in range(0, length):
        ...
        self.current_floor_isolated_zones.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.target_floor_isolated_zones = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1.next_task = str[start:end]
        self.target_floor_isolated_zones.append(val1)
      return self
