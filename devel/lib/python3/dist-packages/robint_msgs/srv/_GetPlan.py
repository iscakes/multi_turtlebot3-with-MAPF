...
"""autogenerated by genpy from robint_msgs/GetPlanRequest.msg. Do not edit."""
import codecs
import sys
...
class GetPlanRequest(genpy.Message):
  _md5sum = "95fedf2a5da853b0850645575457342f"
  _type = "robint_msgs/GetPlanRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# The start pose for the plan
...
float64 w
"""
  __slots__ = ['start','goal','tolerance','pure_mode']
  _slot_types = ['geometry_msgs/PoseStamped','geometry_msgs/PoseStamped','float32','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       start,goal,tolerance,pure_mode
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7dfB().pack(_x.goal.pose.position.x, _x.goal.pose.position.y, _x.goal.pose.position.z, _x.goal.pose.orientation.x, _x.goal.pose.orientation.y, _x.goal.pose.orientation.z, _x.goal.pose.orientation.w, _x.tolerance, _x.pure_mode))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.pose.position.x, _x.goal.pose.position.y, _x.goal.pose.position.z, _x.goal.pose.orientation.x, _x.goal.pose.orientation.y, _x.goal.pose.orientation.z, _x.goal.pose.orientation.w, _x.tolerance, _x.pure_mode,) = _get_struct_7dfB().unpack(str[start:end])
      self.pure_mode = bool(self.pure_mode)
      return self
...
def _get_struct_7dfB():
    ...
    return _struct_7dfB
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robint_msgs/GetPlanResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetPlanResponse(genpy.Message):
  _md5sum = "b23fed6f7026a1bda46577a9f7994361"
  _type = "robint_msgs/GetPlanResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
float64 w
"""
  __slots__ = ['plan','success','error_code']
  _slot_types = ['nav_msgs/Path','bool','uint8']
...
class GetPlan(object):
  _type          = 'robint_msgs/GetPlan'
  _md5sum = 'a932883b63c9b3eddafe2113df5fe719'
