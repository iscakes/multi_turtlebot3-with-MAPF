...
"""autogenerated by genpy from robint_msgs/AddLocationListRequest.msg. Do not edit."""
import codecs
import sys
...
class AddLocationListRequest(genpy.Message):
  _md5sum = "b0c8e364016387e60c2bf6dc5913dec5"
  _type = "robint_msgs/AddLocationListRequest"
...
"""
  ...
  __slots__ = ['location_mode','map_name','map_uuid','location_list']
  _slot_types = ['uint8','string','string','robint_msgs/Location[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       location_mode,map_name,map_uuid,location_list
    ...
    """
    if args or kwds:
      super(AddLocationListRequest, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.location_mode,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robint_msgs/AddLocationListResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class AddLocationListResponse(genpy.Message):
  _md5sum = "fc772c80be7e6c3d4ddf4e9bb17a02e6"
  _type = "robint_msgs/AddLocationListResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
float64 w
"""
  __slots__ = ['location_list','success','error_code']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       location_list,success,error_code
    ...
    """
    if args or kwds:
      super(AddLocationListResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.location_list is None:
        self.location_list = []
...
def _get_struct_4d():
    ...
    if _struct_4d is None:
        _struct_4d = struct.Struct("<4d")
    return _struct_4d
class AddLocationList(object):
  _type          = 'robint_msgs/AddLocationList'
  _md5sum = '71d3bf9e5e9044c1a5eaa8dd7715c1b8'
  _request_class  = AddLocationListRequest
  _response_class = AddLocationListResponse
